...
#class variable(ABC):
#	''' This class will take in the output of operations made using the contents of
#	assemble.grids[variable]. Therefore, assemble.vars will be instances stemming from 
#	this parent class '''
...
class assemble:
    ...
    def concat_xrs(self, variable, sorter, sort=True, wiggle=False):
        ...
        '''
        all_inst = xr.concat( self.grids[variable], dim=sorter ); # sorter is a string
        if wiggle:
